 ...
 * Slug: patterns-travel/section-title-4
...
<h2 class="wp-block-heading has-text-align-center has-default-color has-text-color has-x-large-font-size" style="margin-bottom:var(--wp--preset--spacing--10);font-style:normal;font-weight:700"><?php esc_html_e( 'Try it now !', 'patterns-travel' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Try for Free', 'patterns-travel' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
