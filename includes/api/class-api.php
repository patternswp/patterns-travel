 ...
 * @subpackage Patterns_Travel/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Travel_Api' ) ) {
	 ...
	 * @since 1.0.1
	 */
	class Patterns_Travel_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-travel' ), '1.0.0' );
		}
